...
(defparameter ball-sprite-frames
  (list (sprites::make-sprite-def-frame :name 'frame-1 :x1 0 :y1 0 :x2 31 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-2 :x1 32 :y1 0 :x2 63 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-3 :x1 64 :y1 0 :x2 95 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-4 :x1 96 :y1 0 :x2 127 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-5 :x1 128 :y1 0 :x2 159 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-6 :x1 160 :y1 0 :x2 191 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-7 :x1 192 :y1 0 :x2 223 :y2 31)
	(sprites::make-sprite-def-frame :name 'frame-8 :x1 224 :y1 0 :x2 255 :y2 31)))
